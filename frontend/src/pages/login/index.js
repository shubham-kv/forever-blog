...
export default function Login() {
	const dispatch = useDispatch(),
		...
		[refreshAccessToken, , toastContainerRef] = useContext(AppContext),
		...
		if(!data.hadFetchError) {
			...
			if(ok) {
				...
				if(InputNames.USERNAME === key) {
					...
					passwordInputRef.current.setCustomError(message)
				}
			...
			<div className={styles.login}>
				...
				<form className={styles.loginForm} onSubmit={handleSubmit} noValidate>
					...
					<CustomInput
						...
						inputType='password'
						leadingIcon={
							<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' focusable='false' width='1em' height='1em' fill='none' aria-hidden='true'><path d='M7 10H4V23H20V10H17M7 10C7 10 5.82908 6.0296 7 4C8.13793 2.02758 9.72287 1 12 1C14.2771 1 15.8621 2.02758 17 4C18.1709 6.0296 17 10 17 10M7 10H17M12 19.5V16.5M12 16.5C12 16.5 10.5 15.8284 10.5 15C10.5 14.1716 11.1716 13.5 12 13.5C12.8284 13.5 13.5 14.1716 13.5 15C13.5 15.8284 12 16.5 12 16.5Z' stroke='currentColor' strokeWidth='1.8' ></path></svg>
						}
						/>

					<input className={`${utilStyles.cbtn} ${utilStyles.cbtnRaised} ${styles.loginSubmitBtn}`} type='submit' value='Log In' />
				</form>
